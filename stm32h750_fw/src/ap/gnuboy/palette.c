...
static byte palmap[32768] __attribute__((section(".sram_d1")));
static byte pallock[256] __attribute__((section(".sram_d1")));
static int palrev[256];

/* Course color mapping, for when palette is exhausted. */
static byte crsmap[4][32768] __attribute__((section(".sram_d1")));
static int crsrev[4][256] __attribute__((section(".sram_d1")));
